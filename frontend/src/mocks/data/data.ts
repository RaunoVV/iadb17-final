...
export const workflows: TWorkflow[] = [
	{
		...
		creationTimestamp: "2022-12-05T15:03:25Z",
		spec: {
			hardwareMap: {
	...
	},
	{
		...
		name: "wf2",
		creationTimestamp: "2023-09-26T11:56:59Z",
		spec: {
			hardwareMap: {
	...
	},
	{
		...
		creationTimestamp: "2024-08-23T11:18:37Z",
		spec: {
			hardwareMap: {
				device_1: "52:54:00:f2:ed:9c",
	...
	},
	{
		...
		creationTimestamp: "2024-09-04T08:55:04Z",
		spec: {
			hardwareMap: {
	...
	},
	{
		...
		name: "aaacccc",
		creationTimestamp: "2024-09-16T20:02:12Z",
		spec: {
	...
	},
	{
		...
		name: "jjghjghjghj",
		creationTimestamp: "2024-09-16T20:03:40Z",
		spec: {
			hardwareMap: {
				device_1: "52:54:00:8a:ac:c3",
			},
...
export const templates: TTemplate[] = [
	{
		...
		name: "ubuntu-focal",
		creationTimestamp: "2022-11-25T09:00:33Z",
		spec: {
			data: {
				version: "0.1",
				name: "ubuntu_Focal",
						...
						actions: [
							{
								...
								environment: {
									DEST_DISK: "/dev/vda",
									IMG_URL:
										"http://192.168.123.1:8080/focal-server-cloudimg-amd64.raw.gz",
									COMPRESSED: true,
								},
							},
							{
								...
								environment: {
									...
									CMD_LINE: "growpart /dev/vda 1 && resize2fs /dev/vda1",
								},
							},
							{
							...
							},
							{
								...
								environment: {
									...
									DEFAULT_INTERPRETER: "/bin/sh -c",
									CMD_LINE:
										"ssh-keygen -A; systemctl enable ssh.service; sed -i 's/^PasswordAuthentication no/PasswordAuthentication yes/g' /etc/ssh/sshd_config",
								},
							},
							{
								...
								environment: {
									...
									DEFAULT_INTERPRETER: "/bin/sh -c",
									CMD_LINE:
										"systemctl disable apparmor; systemctl disable snapd",
								},
							},
							{
								name: "write-netplan",
	...
	},
	{
		...
		name: "nixos",
		creationTimestamp: "2022-12-05T13:15:34Z",
		spec: {
			data: {
				version: "0.1",
				name: "debian_Focal",
	...
	},
	{
		...
		name: "nixos2",
		creationTimestamp: "2024-10-14T19:22:00Z",
		spec: {
			data: {
				tasks: [
					{
...
export const hardware: THardware[] = [
	{
		...
		creationTimestamp: "2023-09-21T13:27:11Z",
		spec: {
			interfaces: [
				{
					dhcp: {
	...
	},
	{
		...
		creationTimestamp: "2023-09-21T11:21:25Z",
		spec: {
			interfaces: [
				{
					dhcp: {
	...
	},
	{
		...
		creationTimestamp: "2023-09-25T12:52:45Z",
		spec: {
			interfaces: [
				{
					dhcp: {
	...
	},
	{
		...
		name: "test-hw",
		creationTimestamp: "2024-07-11T17:15:08Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-22T07:11:19Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-22T12:50:40Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-22T12:52:55Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-22T15:13:23Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-23T01:18:31Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		name: "node-525400f2ed9c",
		creationTimestamp: "2023-10-25T12:18:37Z",
		spec: {
			disks: [
				{
					device: "/dev/md0",
	...
	},
	{
		...
		creationTimestamp: "2024-08-24T21:23:52Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-25T09:41:07Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-26T07:05:28Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-26T07:05:31Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-26T07:06:56Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-26T07:07:06Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-27T07:26:28Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-27T07:33:03Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		creationTimestamp: "2024-08-27T07:40:05Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		name: "node-5254008aacc3",
		creationTimestamp: "2024-08-22T07:11:33Z",
		spec: {
			interfaces: [
				{
					dhcp: {
	...
	},
	{
		...
		creationTimestamp: "2024-08-27T07:42:51Z",
		spec: {
			disks: [
				{
					device: "/dev/sda",
	...
	},
	{
		...
		name: "hardware-238",
		creationTimestamp: "2024-10-09T17:18:51Z",
		spec: {
			interfaces: [
				{
					dhcp: {
	...
	},
	{
		...
		name: "hardware-5",
		creationTimestamp: "2024-10-09T17:23:44Z",
		spec: {
			interfaces: [
				{
					dhcp: {
	...
	},
	{
		...
		name: "hardware-68",
		creationTimestamp: "2024-10-09T17:23:58Z",
		spec: {
			interfaces: [
				{
					dhcp: {
